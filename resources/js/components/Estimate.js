...
const items = [
  { key: 'hasDesign', value: 2000, role: 'UI/UX Designer'},
  { key: 'hasPayment', value: 1800, role: null},
  { key: 'hasCMS', value: 2100, role: null},
  { key: 'hasBackend', value: 1900, role: 'Back-end Developer'},
  { key: 'hasFrontend', value: 2500, role: 'Front-end Developer'},
];
          ...
          <div className='pricing-table'>
            ...
            <div className='flex justify-between'>
              ...
              <div className=''>
                ...
                <p className='text-4xl this-black font-bold pt-4'>12<br/></p>
              </div>
            </div>
          </div>
          <div className='pricing-control'>
            ...
            <div className='pt-6'>
              ...
              <div className='flex pt-4'>
                ...
                <button ref={noPaymentBtn => { this.noPaymentBtn = noPaymentBtn; }} onClick={() => this.toggleItem(this.noPaymentBtn, this.yesPaymentBtn, false, 1)} className='inactive-btn flex justify-between px-4'><span className=''>No</span><span className=''>- MYR{items[0].value}</span></button>
              </div>
            </div>
            <div className='pt-6'>
              ...
              <div className='flex pt-4'>
                ...
                <button ref={noCMSBtn => { this.noCMSBtn = noCMSBtn; }} onClick={() => this.toggleItem(this.noCMSBtn, this.yesCMSBtn, false, 2)} className='inactive-btn flex justify-between px-4'><span className=''>No</span><span className=''>- MYR{items[0].value}</span></button>
              </div>
            </div>
            <div className='pt-6'>
              ...
              <div className='flex pt-4'>
                ...
                <button ref={noBackendBtn => { this.noBackendBtn = noBackendBtn; }} onClick={() => this.toggleItem(this.noBackendBtn, this.yesBackendBtn, false, 3)} className='inactive-btn flex justify-between px-4'><span className=''>No</span><span className=''>- MYR{items[0].value}</span></button>
              </div>
            </div>
            <div className='pt-6'>
              ...
              <div className='flex pt-4'>
                ...
                <button ref={noFrontendBtn => { this.noFrontendBtn = noFrontendBtn; }} onClick={() => this.toggleItem(this.noFrontendBtn, this.yesFrontendBtn, false, 4)} className='inactive-btn flex justify-between px-4'><span className=''>No</span><span className=''>- MYR{items[0].value}</span></button>
              </div>
            </div>
          </div>
        </div>
